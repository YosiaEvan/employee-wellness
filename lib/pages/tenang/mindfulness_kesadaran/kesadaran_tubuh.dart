...
class KesadaranTubuh extends StatefulWidget {
  const KesadaranTubuh({super.key});

  @override
  State<KesadaranTubuh> createState() => _KesadaranTubuhState();
}

class _KesadaranTubuhState extends State<KesadaranTubuh> with TickerProviderStateMixin {
  bool isComplete = false;
  final List<String> guide = [
    "Rasakan sensasi di kepala dan wajah",
    "Perhatikan ketegangan di area ini",
    "Rasakan dari bahu hingga ujung jari",
    "Perhatikan gerakan napas",
    "Scan dari atas ke bawah",
    "Dari pinggul hinggal ujung kaki",
  ];
                  ...
                  child: !isComplete
                      ? Column(
                          ...
                          children: [
                            ...
                            const Text(
                              "Scan dan rasakan setiap bagian tubuh",
                              style: TextStyle(
                                fontSize: 20,
                              ),
                              textAlign: TextAlign.center,
                            ...
                            SizedBox(
                              ...
                              child: ElevatedButton(
                                ...
                                style: ElevatedButton.styleFrom(
                                  backgroundColor: const Color(0xffcb3bbd),
