...
class _BodyScanState extends State<BodyScan> with TickerProviderStateMixin {
  late AnimationController _controller;
  static const int totalSeconds = 10 * 60;
  int _remainingSeconds = totalSeconds;
  Timer? _timer;
  SessionStatus _status = SessionStatus.idle;
  final List<String> guide = [
    "Berbaring atau duduk dengan nyaman",
    "Tutup mata dan bernapas dalam",
    "Mulai dari kepala, rasakan sensasinya",
    "Pindah ke bahu, lengan, dada, perut",
    "Lanjut ke kaki hingga ujung jari",
  ];
  ...
  void startTimer() {
    ...
    _timer?.cancel();
    setState(() => _status = SessionStatus.running);
  ...
  void pauseTimer() {
    _timer?.cancel();
    setState(() => _status = SessionStatus.paused);
  }
  ...
  void _onSesionComplete() async {
    ...
    TenangService.recordSession(
      ...
      subKategori: TenangSubKategori.bodyScan,
  ...
  void initState() {
    ...
    _controller = AnimationController(vsync: this, duration: const Duration(minutes: 10));
  }
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          Text("Body Scan", style: TextStyle(fontSize: 20, fontWeight: FontWeight.w700, color: Colors.white)),
                          Text("10 menit sesi", style: TextStyle(fontSize: 16, color: Colors.white)),
                        ],
                      ),
                      SizedBox.square(
                        dimension: 40,
                          ...
                          children: [
                            ...
                            Column(
                              children: [
                                ...
                                SizedBox(height: 16),
                                GestureDetector(
                                  onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => MeditasiTerpadu())),
                                  child: Container(
                                    padding: EdgeInsets.symmetric(horizontal: 20, vertical: 12),
                                    width: double.infinity,
                                    decoration: BoxDecoration(
                                    ...
                                    child: Text("Pilih Meditasi Lain", style: TextStyle(fontSize: 20, fontWeight: FontWeight.w500), textAlign: TextAlign.center),
                                  ),
                                ),
                                SizedBox(height: 16),
                                GestureDetector(
                                  onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => MindfulnessKesadaran())),
                                  child: Container(
                                    padding: EdgeInsets.symmetric(horizontal: 20, vertical: 12),
                                    width: double.infinity,
                                    decoration: BoxDecoration(
                                    ...
                                    child: Text("Lanjut ke Mindfulness", style: TextStyle(fontSize: 20, fontWeight: FontWeight.w500), textAlign: TextAlign.center),
                                  ),
                                ),
                              ],
                            ),
                        ...
                        children: [
                                ...
                                Positioned.fill(
                                  child: AnimatedBuilder(
                                    ...
                                    builder: (context, child) => CircularProgressIndicator(
                                      ...
                                      valueColor: AlwaysStoppedAnimation(Color(0xff7541fc)),
                                    ),
                                  ),
                                ),
                                Column(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(height: 8),
                                    Text(timerText, style: TextStyle(fontSize: 32, fontWeight: FontWeight.bold)),
                                    SizedBox(height: 4),
                                    Text(
                            ...
                            children: [
                              OutlinedButton.icon(
                                ...
                                style: OutlinedButton.styleFrom(
                                  padding: EdgeInsets.symmetric(horizontal: 20, vertical: 12),
                                  foregroundColor: Color(0xff7541fc),
                                  side: BorderSide(color: Color(0xff7541fc)),
                              ...
                              ElevatedButton.icon(
                                ...
                                icon: FaIcon(_status == SessionStatus.running ? FontAwesomeIcons.pause : FontAwesomeIcons.play),
                                label: Text(_status == SessionStatus.running ? "Pause" : "Mulai"),
                                style: ElevatedButton.styleFrom(
                                  padding: EdgeInsets.symmetric(horizontal: 24, vertical: 12),
                                  backgroundColor: Color(0xff7541fc),
                          ...
                          Container(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text("Panduan:", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                                SizedBox(height: 16),
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
