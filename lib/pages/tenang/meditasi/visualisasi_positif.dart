...
class VisualisasiPositif extends StatefulWidget {
  const VisualisasiPositif({super.key});

  @override
  State<VisualisasiPositif> createState() => _VisualisasiPositifState();
}

enum SessionStatus { idle, running, paused, finished }

class _VisualisasiPositifState extends State<VisualisasiPositif> with TickerProviderStateMixin {
  ...
  final List<String> guide = [
    ...
    "Bayangkan tempat favorit Anda",
    "Rasakan detail: warna, suara, dan aroma",
    "Nikmati ketenangan di tempat itu",
    "Bawa perasaan ini ke hari Anda",
  ];
                      ...
                      ? Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const Text(
                                "Selamat! Anda telah menyelesaikan sesi Visualisasi Positif. Bagaimana perasaan Anda sekarang?",
                                style: TextStyle(
                                  fontSize: 20,
                                ),
                                    ...
                                    child: AnimatedBuilder(
                                        ...
                                        builder: (context, child) {
                                          return CircularProgressIndicator(
                                            ...
                                            valueColor: const AlwaysStoppedAnimation(Color(0xfffb7600)),
                                          );
                                        }),
                                  ),
                              ...
                              children: [
                                ...
                                OutlinedButton.icon(
                                  ...
                                  style: OutlinedButton.styleFrom(
                                    padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 12),
                                    foregroundColor: const Color(0xfffb7600),
                                    side: const BorderSide(color: Color(0xfffb7600)),
                                ...
                                ElevatedButton.icon(
                                  ...
                                  style: ElevatedButton.styleFrom(
                                    ...
                                    backgroundColor: const Color(0xfffb7600),
