                                ...
                                child: AnimatedBuilder(
                                    ...
                                    builder: (context, child) {
                                      return CircularProgressIndicator(
                                        ...
                                        valueColor: AlwaysStoppedAnimation(Color(0xfffb7600)),
                                      );
                                    }
                                ),
                              ),
                          ...
                          children: [
                            ...
                            OutlinedButton.icon(
                              ...
                              style: OutlinedButton.styleFrom(
                                padding: EdgeInsets.symmetric(horizontal: 20, vertical: 12),
                                foregroundColor: Color(0xfffb7600),
                                side: BorderSide(color: Color(0xfffb7600)),
                            ...
                            ElevatedButton.icon(
                              ...
                              style: ElevatedButton.styleFrom(
                                ...
                                backgroundColor: Color(0xfffb7600),
