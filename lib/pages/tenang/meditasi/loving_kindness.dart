                                ...
                                child: AnimatedBuilder(
                                    ...
                                    builder: (context, child) {
                                      return CircularProgressIndicator(
                                        ...
                                        valueColor: AlwaysStoppedAnimation(Color(0xffef006d)),
                                      );
                                    }
                                ),
                              ),
                          ...
                          children: [
                            ...
                            OutlinedButton.icon(
                              ...
                              style: OutlinedButton.styleFrom(
                                padding: EdgeInsets.symmetric(horizontal: 20, vertical: 12),
                                foregroundColor: Color(0xffef006d),
                                side: BorderSide(color: Color(0xffef006d)),
                            ...
                            ElevatedButton.icon(
                              ...
                              style: ElevatedButton.styleFrom(
                                ...
                                backgroundColor: Color(0xffef006d),
