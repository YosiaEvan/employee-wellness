...
class LovingKindness extends StatefulWidget {
  const LovingKindness({super.key});

  @override
  State<LovingKindness> createState() => _LovingKindnessState();
}

enum SessionStatus { idle, running, paused, finished }

class _LovingKindnessState extends State<LovingKindness> with TickerProviderStateMixin {
  ...
  final List<String> guide = [
    "Duduk nyaman dan rileks",
    'Ucapkan: "Semoga saya bahagia dan sehat"',
    "Bayangkan orang yang Anda sayangi",
    "Kirim doa yang sama untuk mereka",
    "Perluas ke semua makhluk",
  ];
  ...
  void _onSesionComplete() async {
    ...
    TenangService.recordSession(
      ...
      subKategori: TenangSubKategori.lovingKindness,
                      ...
                      ? Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const Text(
                                "Selamat! Anda telah menyelesaikan sesi Loving Kindness. Bagaimana perasaan Anda sekarang?",
                                style: TextStyle(
                                  fontSize: 20,
                                ),
                                    ...
                                    child: AnimatedBuilder(
                                        ...
                                        builder: (context, child) {
                                          return CircularProgressIndicator(
                                            ...
                                            valueColor: const AlwaysStoppedAnimation(Color(0xffef006d)),
                                          );
                                        }),
                                  ),
                              ...
                              children: [
                                ...
                                OutlinedButton.icon(
                                  ...
                                  style: OutlinedButton.styleFrom(
                                    padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 12),
                                    foregroundColor: const Color(0xffef006d),
                                    side: const BorderSide(color: Color(0xffef006d)),
                                ...
                                ElevatedButton.icon(
                                  ...
                                  style: ElevatedButton.styleFrom(
                                    ...
                                    backgroundColor: const Color(0xffef006d),
