...
class TeknikPernapasan extends StatelessWidget {
  TeknikPernapasan({super.key});
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          Text("Teknik 4-7-8", style: TextStyle(fontSize: 20, fontWeight: FontWeight.w700, color: Colors.white)),
                          Text("2 Menit", style: TextStyle(fontSize: 16, color: Colors.white)),
                        ],
                      ),
                      SizedBox.square(
                        dimension: 40,
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 8),
                          Text("Teknik 4-7-8", style: TextStyle(fontSize: 32, fontWeight: FontWeight.w500)),
                        ],
                      ),
                    ),
                    SizedBox(height: 20),
