...
class _HealthProfileState extends State<HealthProfile> {
  ...
  Future<bool> _checkCredentials() async {
    try {
      ...
      if (credentials == null || (credentials['email'] == null && credentials['password'] == null)) return false;
      return true;
    } catch (e) {
      return false;
    }
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        DropdownButtonFormField<String>(
                                          ...
                                          onChanged: (value) => setState(() => selectedDietType = value),
                                        ),
                                      ],
                                    ),
                                  ),
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        DropdownButtonFormField<String>(
                                          ...
                                          items: const [
                                            DropdownMenuItem(value: "", child: Text("Pilih")),
                                            DropdownMenuItem(value: "Sedentary", child: Text("Sedentary (Jarang)")),
                                            DropdownMenuItem(value: "Light", child: Text("Light (1-3x/minggu)")),
                                            DropdownMenuItem(value: "Moderate", child: Text("Moderate (3-5x/minggu)")),
                                            DropdownMenuItem(value: "Active", child: Text("Active (6-7x/minggu)")),
                                            DropdownMenuItem(value: "Very Active", child: Text("Very Active (2x/hari)")),
                                          ],
