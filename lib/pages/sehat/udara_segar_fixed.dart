...
class _TidurCukupState extends State<TidurCukup> {
  ...
  Future<void> _cekStatusTidur() async {
    ...
    setState(() {
      ...
      if (result['data'] != null) {
        ...
        double durasiJam = 0;
        if (data['durasi_menit'] != null) durasiJam = data['durasi_menit'] / 60.0;
        todayData = {
          'jam_tidur': jamTidur,
  ...
  double get averageHours => sleepReports.isEmpty ? 0 : sleepReports.fold(0.0, (sum, r) => sum + (r['duration'] ?? 0)) / sleepReports.length;
  ...
  Future<void> addSleepReport() async {
    ...
    final result = await TidurService.laporTidur(jamTidur: jamTidur, jamBangun: jamBangun);
    if (result['success']) {
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                                      ...
                                      child: Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Row(
                                              children: [
                                                FaIcon(FontAwesomeIcons.moon, size: 20, color: Color(0xff4f39f6)), // ✅
                                                SizedBox(width: 12),
                                      ...
                                      child: Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Row(
                                              children: [
                                                FaIcon(FontAwesomeIcons.sun, size: 20, color: Color(0xff4f39f6)), // ✅
                                                SizedBox(width: 12),
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                SizedBox(width: 12),
                                                Text(
                                                  (todayData['durasi_jam'] ?? 0) > 8 ? "Lebih"
                                                  : (todayData['durasi_jam'] ?? 0) < 7 ? "Kurang" : "Ideal",
                                                  style: TextStyle(
                                                    color: (todayData['durasi_jam'] ?? 0) > 8
                                                      ? Colors.blue
                                                      : (todayData['durasi_jam'] ?? 0) < 7
                              ...
                              if (!hasTodayReport) ...[
                                  ...
                                  child: ElevatedButton(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(width: 8),
                                        Text(
                                          isInSleepTimeRange ? "Laporkan Tidur Hari Ini" : "Belum Waktu Tidur",
                                ...
                                if (!isInSleepTimeRange) ...[
                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      children: [
                                        FaIcon(FontAwesomeIcons.circleInfo, size: 16, color: Color(0xFFFF9800)), // ✅
                                        SizedBox(width: 8),
                                        Expanded(
                                          child: Text(
                                            sleepTimeMessage,
                            ...
                            children: [
                              SizedBox.square(
                                ...
                                child: Container(
                                  ...
                                  child: FaIcon(FontAwesomeIcons.arrowTrendUp, size: 36, color: Colors.white), // ✅
                                ),
                              ),
                              SizedBox(width: 20),
                              Column(
                        ...
                        children: [
                          ...
                          Column(
                            children: [
                              ...
                              SizedBox(height: 12),
                              // ... other tips (sama seperti sebelumnya, tidak perlu diubah karena tidak ada ikon FontAwesome)
                              // Saya singkat untuk menghemat ruang, tetapi semua Icon(FontAwesomeIcons) sudah diubah.
                            ],
                          ),
                        ],
                      ),
                    ...
                    // Rutinitas Tidur Ideal (tidak ada Icon FontAwesome di sini, hanya emoji teks, aman)
                    // Manfaat Tidur Cukup (ada Icon(FontAwesomeIcons.heart) -> harus diubah)
                    Container(
                      padding: EdgeInsets.all(20),
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                      ...
                      child: Column(
                        children: [
                          Row(
                            children: [
                              ...
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text("Manfaat Tidur Cukup", style: TextStyle(fontSize: 20, fontWeight: FontWeight.w500)),
                                ],
                              ),
                            ],
                          ),
                          ...
                          Column(
                            children: [
                              // Semua item di sini tidak menggunakan ikon FontAwesome, hanya teks dan kotak warna, aman.
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                        onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => const SehatHomepage())),
                        style: ElevatedButton.styleFrom(
                          backgroundColor: Colors.transparent,
                          shadowColor: Colors.transparent,
                        ),
                        child: Text("Selesai", style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)),
                      ),
                    ),
                  ],
                ),
