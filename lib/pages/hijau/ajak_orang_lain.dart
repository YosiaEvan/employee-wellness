                      ...
                      child: Column(
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              _buildStatItem("Diundang", _jumlahDiundang.toString(), Colors.blue),
                              _buildStatItem("Bergabung", _jumlahBergabung.toString(), Colors.green),
                              _buildStatItem("Aktif", _jumlahAktif.toString(), Colors.orange),
                            ],
                          ),
