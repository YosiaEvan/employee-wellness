  ...
  Future<void> register() async {
    ...
    if (result["success"]) {
      ...
      Navigator.pushAndRemoveUntil(
        context,
        MaterialPageRoute(
          builder: (context) => VerifyEmail(email: emailController.text.trim()),
        ),
        (route) => false,
      );
    } else {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                  prefixIcon: FaIcon(FontAwesomeIcons.lock, size: 20), // ✅
                                ...
                                validator: (value) {
                                  ...
                                  if (!hasUppercase) return 'Password harus mengandung huruf kapital';
                                  if (!hasLowercase) return 'Password harus mengandung huruf kecil';
                                  if (!hasDigit) return 'Password harus mengandung angka';
                                  if (!hasSpecialChar) return 'Password harus mengandung simbol';
                                  if (value == '12345678') return 'Password tidak boleh 12345678';
                                  return null;
                                },
                              ),
                              const SizedBox(height: 16),
                              ...
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                  prefixIcon: FaIcon(FontAwesomeIcons.building, size: 20), // ✅
                                ...
                                validator: (value) {
                                  if (value == null || value.isEmpty) return 'Token perusahaan wajib diisi';
                                  if (value.length < 6) return 'Token minimal 6 karakter';
                                  return null;
                                },
                              ),
                              SizedBox(height: 24),
                              ...
                              SizedBox(
                                ...
                                child: ElevatedButton(
                                  ...
                                  child: isLoading
                                      ...
                                      : const Text("Daftar", style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: Colors.white)),
                                ),
                              ),
                              SizedBox(height: 24),
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  GestureDetector(
                                    ...
                                    child: Text("Masuk", style: TextStyle(fontSize: 16, color: Colors.green, fontWeight: FontWeight.w500)),
                                  ),
                                ],
                              ),
                            ],
